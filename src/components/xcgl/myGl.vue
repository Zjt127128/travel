                ...
                <div class="share_item" v-for="(item, index) in shareDiaryList" :key="index">
                    <div class="share_top">
                        ...
                        <div class="user_info">
                            <div class="firt_line_div">
                                <div class="firt_line">
                                    <span class="share_title">{{ item.strategyInformation.title }}</span>
                            ...
                            <div class="second_line">
                                <div class="second_left">
                                    ...
                                    <div class="go_date">
                                        <span class="date_detail">{{ item.strategyInformation.goDate
                                            }}</span><span>出发</span>
                                    </div>
                    ...
                    <div class="share_main">
                        <div class="route_info"
                            ...
                            <span class="rout_type">途经：</span><span>{{ item.strategyInformation.duringBegin
                                }}</span><span class="arrow_right">></span><span>{{
                item.strategyInformation.duringEnd }}</span>
                        </div>
                        <div class="route_info"
                            v-if="item.strategyInformation.eventBegin && item.strategyInformation.eventEnd">
                            <span class="rout_type">行程：</span><span>{{ item.strategyInformation.eventBegin
                                }}</span><span class="arrow_right">></span><span>{{
                item.strategyInformation.eventEnd }}</span>
                        </div>
                        <div class="share_img">
                            <img v-for="(e, i) in item.strategyInformation.imgLists" :src="baseUrl + e" alt="" :key="i"
